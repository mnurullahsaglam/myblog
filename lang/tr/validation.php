...
return [
    ...
    "before_or_equal" => ":attribute şuna eşit ya da daha önceki bir tarih olmalıdır :date.",
    "between" => [
    ...
    "digits" => ":attribute :digits sayı olmalıdır.",
    "digits_between" => ":attribute :min ile :max arasında sayı olmalıdır.",
