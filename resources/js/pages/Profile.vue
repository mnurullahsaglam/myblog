        ...
        <div class="flex max-w-2xl flex-col gap-5">
            ...
            <section class="rounded-lg border border-surface-200 bg-surface-0 p-4 dark:border-[#272B35] dark:bg-[#15171C]">
                ...
                <p class="mb-4 text-sm text-surface-500 dark:text-surface-400">
                    Sign in with Touch ID instead of a password.
                </p>

                <ul v-if="passkeys.length" class="mb-4 flex flex-col divide-y divide-surface-200 dark:divide-[#20232B]">
                    <li
                    ...
                    >
                        ...
                        <div class="min-w-0 flex-1">
                            ...
                            <p class="font-mono text-[11px] text-surface-500">
                ...
                <small
                    v-else-if="!webauthn.isSupported()"
                    class="mt-2 block text-surface-500"
                >{{ webauthn.unsupportedReason() }}</small>
            </section>
        </div>
    </AdminLayout>
</template>
