...
watch(() => props.columns, (columns) => (local.value = cloneColumns(columns)))
    ...
    <AdminLayout title="Task board" :subtitle="`${total} ${total === 1 ? 'task' : 'tasks'}`">
        ...
        <div class="grid gap-4 md:grid-cols-3">
            <section
                ...
                :key="column.key"
                class="rounded-lg border border-surface-200 bg-surface-100/40 p-3 dark:border-[#272B35] dark:bg-[#15171C]/60"
            >
                ...
                <p
                    ...
                    class="py-8 text-center font-mono text-[11px] text-surface-500"
                >Nothing here</p>
            </section>
        </div>
