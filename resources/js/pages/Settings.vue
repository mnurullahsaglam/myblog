                        ...
                        <div class="flex flex-col gap-4 pt-2">
                            ...
                            <div class="flex flex-col gap-1.5">
                                ...
                                <img
                                    ...
                                    alt=""
                                    class="h-24 w-auto rounded border border-surface-200 object-cover dark:border-[#272B35]"
                                >
                                <FileUpload
                                    mode="basic"
                                    accept="image/*"
                        ...
                        <div class="flex flex-col gap-5 pt-2">
                            <div v-for="[group, key, label] in UPLOADS" :key="key" class="flex flex-col gap-1.5">
                                ...
                                <img
                                    ...
                                    alt=""
                                    class="h-16 w-auto rounded border border-surface-200 object-contain dark:border-[#272B35]"
                                >
                                <FileUpload
                                    mode="basic"
                                    accept="image/*"
                            ...
                            <p class="rounded border border-surface-200 p-3 text-[13px] text-surface-500 dark:border-[#272B35]">
