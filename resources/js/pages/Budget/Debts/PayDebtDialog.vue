...
<template>
  <Dialog v-model:visible="visible" modal header="Record a payment" :style="{ width: '30rem' }" @hide="emit('close')">
    <form class="flex flex-col gap-4" @submit.prevent="submit">
      <p v-if="debt" class="text-surface-500 dark:text-surface-400 text-sm">
